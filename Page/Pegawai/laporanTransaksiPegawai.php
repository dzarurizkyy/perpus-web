...
<html lang='en'>
    <head>
      ...
      <!-- Page Title -->
      <title><?= $reportTransactionText. $webName; ?></title>
      <!-- Favicon -->
    ...
    <body>
        ...
        <div class='sidebar'>
            ...
            <div class='sidebar-menus'>
                ...
                <a class='menus-transaction-report' href="laporanTransaksiPegawai.php?nip_pegawai=<?= $adminSelected['nip_pegawai']; ?>">
                    <div class='menus-transaction-report-text' style='font-weight: 600;'><?= $transactionText; ?></div>
                </a>
                <!-- Book Report -->
                <a class='menus-book-report' href="laporanBukuPegawai.php?nip_pegawai=<?= $adminSelected['nip_pegawai']; ?>">
                    <div class='menus-book-report-text'><?= $bookText; ?></div>
                </a>
                <!-- Logout -->
        ...
        <div class='report'>
            <!-- Title -->
            <h1 class='report-text'><?= $reportTransactionText ?></h1>
            <div class="report-export">
                <!-- Export PDF -->
                <a target='_blank' href='exportTransaksiPdf.php' class='export-pdf'>
                    <?= $exportPDFText; ?>
                </a>
                <!-- White Space -->
                <span>&nbsp;&nbsp;</span>
                <!-- Export Excel -->
                <a href='exportTransaksiExcel.php' class='export-excel'>
                    <?= $exportExcelText; ?>
                </a>
            </div>
        </div>
